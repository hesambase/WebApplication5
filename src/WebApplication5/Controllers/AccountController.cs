...
namespace WebApplication5.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            ViewData["ReturnUrl"] = "Operation/Index";
            return View();
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    cn.Open();
                    SqlCommand cm1 = new SqlCommand("Select Id  from AspNetUsers  where Email='" + model.Email+"'", cn);
                    ...
                    cn.Open();
                    SqlCommand cm = new SqlCommand("Select RoleId  from AspNetUserRoles INNER JOIN AspNetUsers on UserId=Id where UserId='"+UserId+"'", cn);
                    SqlDataReader reader1 = cm.ExecuteReader();
                    while (reader1.Read())
                    {
                        RoleId = (string)reader1["RoleId"];
                    }
                    reader1.Dispose();
                    cn.Close();
                    if (RoleId=="1")
                    ...
                    {
                        cn.Open();
                        SqlCommand cm3 = new SqlCommand("Select Id  from Workers where Email='" + model.Email + "'", cn);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    string cn = configuration.GetSection("ConnectionStrings").GetSection("DefaultConnection").Value;
                   // SqlConnection cn = new SqlConnection("Data Source=(local);Integrated Security=False;User ID=clnsyste_Hesam;Connect Timeout=15;Encrypt=False;Packet Size=4096");

                    cn.Open();
                    SqlCommand cm = new SqlCommand("INSERT INTO AspNetUserRoles  (UserId,RoleId) Values((Select Top 1 Id from AspNetUsers Order by RegDate DESC),'2')", cn);
                    cm.ExecuteNonQuery();
                    cn.Close();
